 ...
 */var G={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},H=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&g(e,t)}(a,e);var t,n,r,o,i=(t=b(),function(){var e,n=m(a);if(t){var r=m(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return E(e)}(this,e)});/**
   ...
   */function a(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},u=arguments.length>3?arguments[3]:void 0;return h(this,a),y(E(r=i.call(this)),"logger",void 0),y(E(r),"speedAdjustment",0),/**
     ...
     * @return {Promise<void>}
     */function(e,t){return new Promise(function(n){!function r(){e.readyState===t?n():e.addEventListener("readystatechange",r,{once:!0})}()})}}]),a}(/*#__PURE__*/k(EventTarget)),Q=new WeakMap,Y=new WeakMap,$={},B=/*#__PURE__*/function(){var e;/**
   * Create a Player.
   *
...
r.element=i,r._originalElement=e,n=e,o=L.get(n),L.set(i,o),L.delete(n),Q.set(r.element,r),t)}).catch(n)}});if(// Store a copy of this Player in the map
Y.set(this,a),Q.set(this.element,this),"IFRAME"===this.element.nodeName&&V(this,"ping"),$.isEnabled){var u=function(){return $.exit()};this.fullscreenchangeHandler=function(){$.isFullscreen?A(r,"event:exitFullscreen",u):I(r,"event:exitFullscreen",u),// eslint-disable-next-line
r.ready().then(function(){V(r,"fullscreenchange",$.isFullscreen)})},$.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.querySelector("#vimeo-player"),ep=new B(eh);ep.setQuality("240p"),ep.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function(e){ep.getCurrentTime().then(function(e){console.log(e),localStorage.setItem("videoplayer-current-time",e)})},2e3)),ep.setCurrentTime(localStorage.getItem("videoplayer-current-time")).then(function(e){localStorage.getItem("videoplayer-current-time")}).catch(function(e){e.name});//# sourceMappingURL=02-video.a3d75cf3.js.map

//# sourceMappingURL=02-video.a3d75cf3.js.map
